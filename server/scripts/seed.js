...
const CATALOGUE = [
  {
    store: 'nova-supply-co',
    category: 'audio',
    brand: 'Nova',
    title: 'Aurora Wireless Headphones',
    slug: 'aurora-wireless-headphones',
    description:
      'Over-ear wireless headphones with 40 hour battery life, active noise cancelling and fast charging. Memory foam earcups for all-day comfort.',
    priceMinor: 24999,
    quantity: 24,
    rating: '4.6',
    ratingCount: 218,
  },
  {
    ...
    description:
      'Compact wireless earbuds with 6 hours per charge and 24 hours from the case. Sweat resistant, good for running.',
    priceMinor: 7900,
    quantity: 60,
    rating: '4.2',
    ratingCount: 94,
  },
  {
    ...
    description:
      'Wired open-back headphones for mixing and mastering. Flat frequency response, replaceable cable. No battery required.',
    priceMinor: 31900,
    quantity: 6,
    rating: '4.9',
    ratingCount: 47,
  },
  {
    ...
    description:
      'Warm dimmable desk lamp with three brightness levels and a weighted brass base. Low glare for long working sessions.',
    priceMinor: 8900,
    quantity: 2,
    rating: '4.1',
    ratingCount: 31,
  },
  {
    ...
    slug: 'paper-floor-lamp',
    description:
      'Hand-folded paper shade on an ash frame. Diffuse, even light for a living room corner.',
    priceMinor: 15900,
    quantity: 11,
    rating: '4.7',
    ratingCount: 22,
  },
  {
    ...
    description:
      'Compact 65 percent mechanical keyboard with hot swappable switches and PBT keycaps. USB-C, no software required.',
    priceMinor: 15750,
    quantity: 0,
    rating: '4.4',
    ratingCount: 76,
  },
  {
    ...
    category: 'workspace',
    brand: 'Nova',
    title: 'Grid Laptop Stand',
    slug: 'grid-laptop-stand',
    description:
      'Aluminium laptop stand that raises the screen to eye level. Folds flat for travel, holds up to 16 inch machines.',
    priceMinor: 5400,
    quantity: 40,
    rating: '4.5',
    ratingCount: 143,
  },
  {
    ...
    description:
      'Set of four hand-thrown stoneware mugs in a matte glaze. Dishwasher and microwave safe.',
    priceMinor: 4800,
    quantity: 18,
    rating: '4.8',
    ratingCount: 65,
  },
  {
    ...
    description:
      'Stonewashed linen throw that softens with every wash. Generous size for a two seater sofa.',
    priceMinor: 11900,
    quantity: 9,
    rating: '4.3',
    ratingCount: 38,
  },
  {
    ...
    category: 'workspace',
    brand: 'Nova',
    title: 'Field Notebook Trio',
    slug: 'field-notebook-trio',
