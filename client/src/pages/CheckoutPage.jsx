...
export function CheckoutPage() {
  ...
  async function submit(event) {
    ...
    setError(null)
    try {
      const order = await orderApi.create({ shippingAddress: address, billingAddress: address })
      const result = await paymentApi.createCheckout(order.data.data.order._id, crypto.randomUUID())
